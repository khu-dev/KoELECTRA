...
class MaliciousProcessor(object):
    """Processor for the Malicious data set """
...
seq_cls_tasks_num_labels = {"kornli": 3, "nsmc": 2, "malicious": 2, "paws": 2, "korsts": 1, "question-pair": 2, "hate-speech": 3}
